...
const UpdateProduct = () => {
    ...
    const fetchProduct = async () => {
      try {
        const response = await axios.get(
          `https://demo-deployment-usbw.onrender.com/api/product/${id}`
        );

        setProduct(response.data);
      
        const responseImage = await axios.get(
          `https://demo-deployment-usbw.onrender.com/api/product/${id}/image`,
          { responseType: "blob" }
        );
  ...
  console.log("formData : ", updatedProduct)
    axios
      .put(`https://demo-deployment-usbw.onrender.com/api/product/${id}`, updatedProduct, {
        headers: {
